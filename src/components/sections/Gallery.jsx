...
const Gallery = () => {
  ...
  return (
    <>
      <section id="gallery" className="w-full flex items-center justify-center">
        <div
        ...
        >
          ...
          >
            <img
              src="/images/Gallery/PanahKiri.svg"
              className="w-[42px] h-[52px]"
            />
          </button>
          ...
          >
            <img
              src="/images/Gallery/PanahKanan.svg"
              className="w-[42px] h-[52px]"
            />
          </button>
        </div>
