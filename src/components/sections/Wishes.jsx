          ...
          <div className="flex flex-col items-center">
            ...
            >
              <input
                ...
                className="w-full text-[#4E4E4E] font-century text-[12px] bg-transparent border-[0.5px] border-[#4E4E4E]/50 px-[12px] h-[33px] rounded-full outline-none placeholder:text-[#4E4E4E]/50"
              />
              <textarea
                value={pesan}
